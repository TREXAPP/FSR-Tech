...
class DonorResourcePageController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.edit_resource_page_donor')->with([
              'resource' => $resource,
          ]);
    }
    ...
    public function handle_post(Request $request)
    {
        ...
        return redirect(route('admin.resource_page_donor'))->with('status', "Измените се успешно зачувани!");
    }
