...
<section class="content active-listings-content">
	...
	<div class="profile-box box">
		...
		<form id="edit-profile-form" class="" action="{{ route('donor.edit_profile') }}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
			<div class="listing-box-body-wrapper">
				<div class="box-body">
					...
					<div id="profile-info" class="col-md-8 col-xs-12 profile-info">
						...
						<div class="row form-group{{ ($errors->has('profile-first-name') || $errors->has('profile-first-name')) ? ' has-error' : '' }}">
						...
						<div class="row  form-group{{ ($errors->has('profile-last-name') || $errors->has('profile-last-name')) ? ' has-error' : '' }}">
						...
						<div class="row form-group{{ ($errors->has('profile-address') || $errors->has('profile-address')) ? ' has-error' : '' }}">
						...
						<div class="row form-group{{ ($errors->has('profile-phone') || $errors->has('profile-phone')) ? ' has-error' : '' }}">
						...
						<div class="row form-group{{ ($errors->has('profile-location') || $errors->has('profile-location')) ? ' has-error' : '' }}">
			...
			<div class="box-footer text-center">
				<div class="pull-right">
					<a href="{{url('donor/change_password')}}" id="change-password-button" name="change-password-button"
					...
					<a href="{{route('donor.profile')}}" id="cancel-edit-profile" name="cancel-edit-profile" class="btn btn-default">Откажи</a>
				</div>
			</div>
		</form>
