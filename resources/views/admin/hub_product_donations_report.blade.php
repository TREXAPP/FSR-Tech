...
@section('content')
  ...
  <section class="content-header product-donations-report-content-header">
    ...
    <ol class="breadcrumb hidden-sm hidden-xs">
      ...
      <li><a href="{{route('admin.hub_product_donations_report')}}"><i class="fa fa-cutlery"></i> Донации од хабови по производ</a></li>
    </ol>
  </section>
...
<section class="content product-donations-report-content">
  ...
  <section class="filter product-donations-report-filter">
  	<div class="filter-wrapper row">
    	<form id="product-donations-report-filter-form" class="product-donations-report-filter-form" action="{{route('admin.hub_product_donations_report')}}" method="post">
...
<div id="product_donations_table" class="col-md-12">
  <div class="panel panel-primary">
    <div class="panel-heading">Донации од хабови по производ</div>
        ...
        @foreach ($products as $product)
          <tr>
            ...
            <?php
              ...
              $hub_listings = FSR\HubListing::where('date_listed', '>=', $date_from)
              ...
              foreach($hub_listings as $hub_listing) {

                //quantity donated and accepted
                if ($hub_listing->quantity_type_id != $current_quantity_type_id) {
                  if (!$first_listing) {
                  ...
                  $current_quantity_donated = 0;
                  $current_quantity_accepted = 0;
                  $current_quantity_type_id = $hub_listing->quantity_type_id;
                  $current_quantity_type = $hub_listing->quantity_type->name;
                }
                ...
                $current_quantity_donated += $hub_listing->quantity;
                //portions donated
                $portions_donated += $hub_listing->quantity / $current_portion_size;

                foreach($hub_listing->listing_offers->where('offer_status','active') as $listing_offer) {
