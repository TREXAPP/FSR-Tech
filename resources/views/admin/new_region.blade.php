...
<!-- Main content -->
  ...
  <div class="box col-md-12">
    <div class="box-header with-border">
      <p class="box-title">Внесете ги податоците за новиот регион</p>
    </div>
    <form id="new_food_type_form" class="" action="{{ route('admin.new_region') }}" method="post" enctype="multipart/form-data">
      {{ csrf_field() }}
