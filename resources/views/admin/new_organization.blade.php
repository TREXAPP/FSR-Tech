      ...
      <div class="row">
        <div class="col-xs-12 ">
          ...
          <br/>
            ...
            <!-- region -->
            <div class="form-group{{ $errors->has('region') ? ' has-error' : '' }} row region"
              {!! (old('type') != 'hub') ? ' style="display: none; visibility: hidden;"' : '' !!}>
              <label for="region" class="col-md-2 col-md-offset-2 control-label">Регион</label>
              <div class="col-md-6">
