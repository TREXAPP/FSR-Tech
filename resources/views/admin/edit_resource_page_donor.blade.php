...
<section class="content-header resource-page-content-header">
	<h1>
		...
		<span>Измени ја страната за известување за донаторите</span>
	</h1>
...
<section class="content resource-page-content edit-resource-page-content">
	...
	<form id="edit-resource-page-form" class="" action="{{ route('admin.resource_page_donor') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
