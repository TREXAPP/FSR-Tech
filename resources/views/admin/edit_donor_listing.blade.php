...
<section class="content listing-content edit-listing-content">
	...
	<form id="edit-listing-form" class="" action="{{ route('admin.edit_donor_listing',$listing->id) }}" method="post" enctype="multipart/form-data">
		...
		<div class="listing-box-body-wrapper">
			<div class="box-body">
				...
				<div class="form-group{{ $errors->has('food_type') ? ' has-error' : '' }} row">
					...
					<div class="col-md-6">
						<select id="food_type_select_admin_donor" class="form-control" name="food_type" required>
				...
				<div class="form-group{{ $errors->has('product_id') ? ' has-error' : '' }} row">
					...
					<div class="col-md-6">
						<select id="product_id_select_admin_donor" class="form-control" name="product_id" required>
					...
					<div class="form-group{{ $errors->has('quantity') ? ' has-error' : '' }} row">
						...
						<div class="col-md-6">
							...
							<div class="col-xs-6" style="padding-right: 0;">
								<select id="quantity_type_admin_donor" class="form-control" name="quantity_type">
