...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb hidden-sm hidden-xs">
      ...
      <li><a href="/{{Auth::user()->type()}}/new_hub_listing"><i class="fa fa-plus-circle"></i> Додади нова донација</a></li>
    </ol>
  </section>
{{--
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-xs-12 ">
          ...
          <form id="new_hub_listing_form" class="" action="{{ route('hub.new_hub_listing') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group{{ $errors->has('food_type') ? ' has-error' : '' }} row">
              ...
              <div class="col-md-6">
                <select id="food_type_select_hub" class="form-control" name="food_type" required>
            ...
            <div class="form-group{{ $errors->has('product_id') ? ' has-error' : '' }} row">
              ...
              <div class="col-md-6">
                <select id="product_id_select_hub" class="form-control" name="product_id"  {{ (!old('food_type')) ? ' disabled' : '' }} required>
                    <option value="">-- Избери --</option>
                @if ($products)
            ...
            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} row">
              ...
              <div class="col-md-6">
                {{-- <textarea rows="4" form="new_hub_listing_form" id="description" class="form-control" name="description" required >{{ old('description') }}</textarea> --}}
                <textarea rows="4" form="new_hub_listing_form" id="description" class="form-control"
            ...
            <div class="form-group{{ $errors->has('sell_by_date') ? ' has-error' : '' }} row">
              ...
              <div class="col-md-6">
                ...
                <div class="col-xs-6" style="padding-left: 0px;">
                  <input id="sell_by_date_hub" type="number" name="sell_by_date" min="0" max="99999999" step="1"  class="form-control"
                        name="sell_by_date" value="{{old('sell_by_date')}}" style="text-align: center;" required >
                </div>
                <div class="col-xs-6"  style="padding-right: 0px;">
                  <select id="time_type_sell_by_hub" class="form-control" name="time_type_sell_by">
