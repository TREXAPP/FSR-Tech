...
<section class="content active-listings-content">
	...
	<form id="edit-profile-form" class="" action="{{ route('hub.edit_profile') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
		...
		<div class="box-footer text-center">
			<div class="pull-right">
				<a href="{{url('hub/change_password')}}" id="change-password-button" name="change-password-button"
				...
				<a href="{{route('hub.profile')}}" id="cancel-edit-profile" name="cancel-edit-profile"
