...
$('.admin-edit-comment-button-cso').on('click', function () {
  var comment_id = this.id.replace('admin-edit-comment-button-cso-', '');
...
$('.admin-delete-comment-button-cso').on('click', function() {
  var comment_id = this.id.replace('admin-delete-comment-button-cso-','');
    var controls = $(this).closest('.admin-comment-controls');
    var listing_offer = $(this).closest('.admin-comment-controls')[0].id.replace('admin-comment-controls-','');
